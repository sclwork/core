...
public abstract class BaseWebFragment extends BaseFragment implements DownloadListener {
  /**
   * Args中的LOAD_URL参数
   */
...
//    }
  ...
  protected final BaseWebClient createWebClient() {
    BaseWebClient client = onCreateWebClient();
    if (client == null) {
  ...
  protected final BaseChromeClient createChromeClient() {
    BaseChromeClient client = onCreateChromeClient();
    if (client == null) {
...
//    }
   ...
   */
  protected BaseWebClient onCreateWebClient() {
    return null;
  }
...
//    }
  ...
  private void setWebChromeClientCore() {
    if (mWebView != null) {
      mWebView.setWebChromeClient(new BasicChromeClient(
...
//        }
  ...
  private final class JWebClient extends BaseWebClient {
    @Override
  ...
  private final class JChromeClient extends BaseChromeClient {
    @Override
  ...
  private BasicChromeClient.OnCustomViewChangeListener mOnCustomViewChangeListener =
      new BasicChromeClient.OnCustomViewChangeListener() {
    @Override
