...
//
//    public BaiduAutoCheck(Context context, final Handler handler, boolean enableOffline) {
...
//            @Override
//            public void run() {
//                BaiduAutoCheck obj = checkAsrInternal(params);
//                name = "识别";
...
//    }
//
//    private BaiduAutoCheck checkAsrInternal(Map<String, Object> params) {
