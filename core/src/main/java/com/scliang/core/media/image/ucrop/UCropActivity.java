...
import com.scliang.core.media.image.ucrop.callback.BitmapCropCallback;
import com.scliang.core.media.image.ucrop.model.AspectRatio;
import com.scliang.core.media.image.ucrop.util.SelectedStateListDrawable;
import com.scliang.core.media.image.ucrop.view.CropImageView;
...
public abstract class UCropActivity extends BaseActivity {
...
//    private boolean mShowLoader = true;
    ...
    private int[] mAllowedGestures = new int[]{ALL, SCALE, ROTATE};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDesc = intent.getStringExtra(UCrop.EXTRA_DESC);
...
//    }
    ...
    public void onBackPressed() {
        setResultError(new Exception("UserBack."));
        finish();
    }
    ...
    /**
     * This method extracts {@link com.scliang.core.media.image.ucrop.UCrop.Options #optionsBundle} from incoming intent
     * and setups Activity, {@link OverlayView} and {@link com.scliang.core.media.image.ucrop.view.CropImageView} properly.
     */
...
//        mShowLoader = true;
    ...
    protected void setResultUri(Uri uri, float resultAspectRatio, int imageWidth, int imageHeight) {
        setResult(RESULT_OK, new Intent()
                .putExtra(UCrop.EXTRA_DESC, mDesc)
    ...
    protected void setResultError(Throwable throwable) {
        setResult(UCrop.RESULT_ERROR,
                new Intent().putExtra(UCrop.EXTRA_DESC, mDesc)
