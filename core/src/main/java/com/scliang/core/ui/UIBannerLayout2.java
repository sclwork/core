 ...
 * on 2018/9/12.
 */
public class UIBannerLayout2<T extends IBanner> extends BaseViewGroup
    ...
    private UIPointsBar2 mPointBar;
    ...
    public UIBannerLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UIBannerLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onInit() {
        ...
        mIndicatorPaddingBottom = dp2px(15);
        // init
        mViewPager = new ViewPager(context);
        mBannerAdapter = new BannerAdapter<>(context,
            this, this, this);
        mPointBar = new UIPointsBar2(context);
        // set
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mPointBar != null) {
            ...
            int l = (mWidth - w) / 2;
            int t = mHeight - h - mIndicatorPaddingBottom;
    ...
    public void setIndicatorPaddingBottom(int paddingBottom) {
